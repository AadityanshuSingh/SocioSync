...
const {isFileTypeSupported, uploadFileToCloudinary} = require("../utils/fileUploader")
...
exports.updateDisplayPicture = async (req, res) => {
	...
	const updatedProfile = await Profile.findByIdAndUpdate(userProfile.profile._id, {
		profileImage: image.secure_url}, {new:true});
